...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_ESC,    KC_LCTL,    KC_LGUI,    KC_LALT,    KC_SPC,        KC_ENT, KC_LANG2,  KC_LANG1, KC_LANG2, KC_LANG2, KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [1] = LAYOUT( \
    ...
    XXXXXXX,   _______,    _______,    _______,    XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,   KC_HOME, KC_PGDN, KC_END \
  )
};
